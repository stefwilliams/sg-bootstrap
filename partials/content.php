...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( is_sticky() AND is_home() ) : ?>
		<hgroup>
			...
			<h4 class="entry-format"><?php _e( 'Featured', 'the-bootstrap' ); ?></h4>
		</hgroup>
	<?php
		else :
			the_title( '<h4 class="entry-title"><a href="' . get_permalink() .'" title="' . sprintf( esc_attr__( 'Permalink to %s', 'the-bootstrap' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark">', '</a></h4>' );
		endif;
